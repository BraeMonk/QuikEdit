...
const BUILT_IN_PALETTES = {
    ...
    default: isLightMode
        ? ['transparent', '#000000', '#FFFFFF', '#C0C0C0', '#808080', '#404040', '#FF0000', '#00FF00', '#0000FF', '#FFFF00', '#FF00FF']
        : ['transparent', '#000000', '#F8F8F8', '#D0D0D0', '#808080', '#404040', '#FF4444', '#44FF44', '#4444FF', '#FFFF44', '#FF44FF'],
    retro8bit: ['transparent', '#000000', '#7C7C7C', '#BCBCBC', '#E8E8E8', '#F4F4F4', '#A00000', '#FF6A00', '#FFD500', '#00A844', '#0047AB'],
    gameboyClassic: ['transparent', '#071821', '#306230', '#8BAC0F', '#9BBB0F', '#E0F8D0'],
    synthwave: ['transparent', '#2D1B69', '#8000FF', '#0080FF', '#00FFFF', '#80FF00', '#FFFF00', '#FF8000', '#FF4080', '#FF0080', '#FF00FF'],
};
